...
var Tap = utils.Tap;
var f = utils.f;
var debug = function () {}; // util.debuglog no-op for browser
...
utils.inherits(PrimitiveType, Type);
...
utils.inherits(NullType, PrimitiveType);
...
utils.inherits(BooleanType, PrimitiveType);
...
utils.inherits(IntType, PrimitiveType);
...
utils.inherits(LongType, PrimitiveType);
...
utils.inherits(FloatType, PrimitiveType);
...
utils.inherits(DoubleType, PrimitiveType);
...
utils.inherits(StringType, PrimitiveType);
...
utils.inherits(BytesType, PrimitiveType);
...
utils.inherits(UnwrappedUnionType, UnionType);
...
utils.inherits(WrappedUnionType, UnionType);
...
utils.inherits(RecordType, Type);
...
utils.inherits(LogicalType, Type);
...
utils.inherits(AbstractLongType, LongType);
